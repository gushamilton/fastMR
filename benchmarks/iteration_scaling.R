...
md <- c("# fastMR implementation and scaling iteration","","Prior native TwoSampleMR 50x50 reference: 339.139 seconds at nboot=100.","","| component | nboot | threads | median seconds | minimum seconds | rows/pairs |","|---|---:|---:|---:|---:|---:|")
